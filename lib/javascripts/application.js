$().ready(function() {
    ...
    var items = [
        "4015RD", "4015Green", 
		"8028D-RD", "8028D", "8028D-BL", "8028D-YL","8028D-GR", 
		"6046BK", "6046RD", "6046GR", "6046PNK", "6046LG", "6046BKCase", 
		"8018T", "8019T", "8013T", 
		"Z3BK", "Z3BLU", "Z3RD", "Z3SLV", 
		"Z4BK", "Z4BLU", "Z4RD", "Z4SLV",
		"W4BK", "W4BLU", "W4RD", "W4SLV",
		"W3BK", "W3BLU", "W3RD", "W3SLV",
		"MUG-WHITE","MUG-BK-BS"
    ];
    ...
    $("#item-nickname").autocomplete({
        position: { my : "right top", at: "right bottom" },
        source: function(request, response) {
            var str = _leftMatch(request.term, $("#item-nickname")[0]);
            str = (str != null) ? str[0] : "";
